...
def test_collect_mixed_quest_screens(vanilla_data_table, default_flags):
    ...
    expected_both_quest_screens = [
        0x1, 0x3, 0x4, 0x7, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10, 0x12, 0x13, 0x14,
        0x16, 0x1a, 0x1c, 0x1e, 0x1f, 0x22, 0x25, 0x26, 0x28, 0x2d, 0x2f, 0x33,
        0x34, 0x37, 0x3c, 0x3d, 0x42, 0x44, 0x45, 0x46, 0x48, 0x4a, 0x4b, 0x4d,
        0x4e, 0x51, 0x56, 0x5b, 0x5e, 0x63, 0x64, 0x66, 0x68, 0x6a, 0x6f, 0x70,
        0x74, 0x75, 0x76, 0x77, 0x78, 0x7c, 0x7d
    ]

    # Expected total screens (both quest + single quest screens)
    expected_total_screens = [
        # Both quest screens first
        0x1, 0x3, 0x4, 0x7, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10, 0x12, 0x13, 0x14,
        0x16, 0x1a, 0x1c, 0x1e, 0x1f, 0x22, 0x25, 0x26, 0x28, 0x2d, 0x2f, 0x33,
        0x34, 0x37, 0x3c, 0x3d, 0x42, 0x44, 0x45, 0x46, 0x48, 0x4a, 0x4b, 0x4d,
        0x4e, 0x51, 0x56, 0x5b, 0x5e, 0x63, 0x64, 0x66, 0x68, 0x6a, 0x6f, 0x70,
        0x74, 0x75, 0x76, 0x77, 0x78, 0x7c, 0x7d,
        # Single quest screens
        0x0, 0x2, 0x5, 0x6, 0x9, 0x11, 0x15, 0x18, 0x19, 0x1b, 0x20, 0x21, 0x27,
        0x29, 0x2b, 0x2c, 0x30, 0x3a, 0x47, 0x53, 0x58, 0x60, 0x62, 0x67, 0x6b,
        0x6c, 0x6d, 0x6e, 0x71, 0x72, 0x7b
    ]
    ...
    assert len(both_quest_screens) == 57, \
        f"Expected 57 both quest screens, got {len(both_quest_screens)}"
